...
public class Grafo {
     ...
     */
    public String rutasString(ListaClientes clientes, ListaAlmacenes almacen) {
        String rutas = "";
        if (!this.isEmpty()) {
                ...
                for (int j = 0; j < maxNodos; j++) {
                    if (this.matrizAdy[i][j] > 0) {
                        if (i + 1 > clientes.size && j + 1 > clientes.size) {
                            ...
                            Almacen temp1 = almacen.first;
                            Almacen temp2 = almacen.first;
                            ...
                            rutas += temp1.Nombre+ "," + temp2.Nombre + "," + Integer.toString(this.matrizAdy[i][j]);
                        } else if (i + 1 > clientes.size) {
                            int rest = i - clientes.size;
                            Almacen temp = almacen.first;
                            for (int x = 0; x < rest; x++) {
                                temp = temp.next;
                            }
                            rutas += temp.Nombre + "," + Integer.toString(j + 1) + "," + Integer.toString(this.matrizAdy[i][j]);
                            ...
                            rutas += Integer.toString(i + 1) + "," + temp.Nombre + "," + Integer.toString(this.matrizAdy[i][j]);
                        } else {
